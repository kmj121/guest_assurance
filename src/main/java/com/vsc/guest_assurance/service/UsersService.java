...
public class UsersService {
    ...
    public PageBean<BUserListVo> list(String email, String userName, Integer roleId, int page, int size) {
        String orderBy = "u.id desc";
        PageHelper.startPage(page, size, orderBy);
        List<BUserListVo> vos = usersMapper.selectList(email, userName, roleId);
    ...
    public CLoginTokenVo login(String token, String type, String ip, Integer language) {
        ...
        //数据库对比
        Users users = usersMapper.selectByUserNameAndType(user.userPrincipalName, Constant.USER_TYPE_ADMIN);
        if (users == null) {
        ...
        bLoginTokenVo.setType(users.getType());
